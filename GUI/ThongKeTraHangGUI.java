...
public class ThongKeTraHangGUI extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel lblTitle = new JLabel("BÁO CÁO THỐNG KÊ TRẢ HÀNG", JLabel.CENTER);
        ...
        pnlFilter.add(createLabel("Hoàn từ (VNĐ):"));
        ...
        lblTongPhieu = createCardLabel("TỔNG SỐ PHIẾU TRẢ", "0", Color.decode("#FF8FB7"));
        lblTongTien = createCardLabel("TỔNG TIỀN ĐƯỢC HOÀN", "0 VNĐ", Color.decode("#90CAF9"));
        ...
        // ============ TABLE ============
        String[] cols = {"MÃ NHÀ CUNG CẤP", "TÊN NHÀ CUNG CẤP", "SỐ LẦN TRẢ HÀNG", "TỔNG TIỀN ĐƯỢC HOÀN"};
        ...
        pnlTable.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(colorText), "PHÂN TÍCH TRẢ HÀNG THEO NHÀ CUNG CẤP"));
    ...
    private void loadDataAndCalculate(String keyword, Double minPrice, Double maxPrice) {
        ...
        for (NhaCungCapDTO ncc : nccBUS.getListNCC()) {
            ...
            for (PhieuTraNhaCungCapDTO pt : ptnBUS.getListPTN()) {
                if (pt.getMaNCC() == ncc.getMaID()) {
                    soLan++;
                    tongTienNCC += pt.getTongTienHoan();
                }
            }
        ...
        btnXuatExcel.addActionListener(e -> {
            ...
            if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    Sheet sheet = workbook.createSheet("ThongKeTra");
        ...
        btnXuatPDF.addActionListener(e -> {
            ...
            if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    document.add(new Paragraph("BÁO CÁO THỐNG KÊ TRẢ HÀNG", fontTitle));
                    document.add(new Paragraph("Tổng số phiếu trả: " + lblTongPhieu.getText(), fontInfo));
                    document.add(new Paragraph("Tổng tiền được hoàn: " + lblTongTien.getText(), fontInfo));
